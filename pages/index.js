  ...
  return (
    <ParallaxProvider>
      ...
      <div className="flex flex-col items-center mt-24">
        ...
        <div id="howto" className="w-full flex justify-center bg-gray-100 py-24 lg:py-48" >
          <HowTo>
      ...
      <div id="roadmap" className="flex flex-col items-center text-pink-100 my-24 lg:my-48">
        <SectionTitle>
          Moon Map
        </SectionTitle>
        <RoadMap>
